...
Представим, что мы работаем в примитивной файловой системе без каких-либо файловых блокировок. Требуется создать собственную библиотеку файловых блокировок на основе создания файлов .lck, где — имя блокируемого файла.
